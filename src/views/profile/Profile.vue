<template>
  <div id="profile">
    <nav-bar class="nav-bar"><div slot="center">购物商场</div></nav-bar>
...
<script>
import UserInfo from './childProfile/UserInfo.vue'
import ListView from './childProfile/ListView.vue'
...
export default {
  ...
  data: function() {
    return {
      orderList: [
        { icon: '#order', iconColor: '#d46b7e', info: '我的消息' },
